 ...
 */
package org.bupt.delaydetect.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.bupt.delaydetect.cli.api.DelaydetectCliCommands;
...
public class DelaydetectCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DelaydetectCliTestCommand.class);
    protected final DelaydetectCliCommands service;

    public DelaydetectCliTestCommand(final DelaydetectCliCommands service) {
